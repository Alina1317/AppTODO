						...
						<div className={styles.about}>
							...
							<div className={styles.user}>
								...
								<div className={styles.social}>
									<a href={userData.html_url} target="_blank" rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21"><g fill="none" stroke="#434A54" strokeLinecap="round" strokeMiterlimit="1" strokeLinejoin="round"><circle cx="10.5" cy="10.5" r="10"/><path d="M8.548 15.751c.004.67.011 1.619.011 1.81M12.53 17.517c0-.252.009-1.646.009-2.669 0-.713-.245-1.178-.519-1.415 1.702-.19 3.49-.836 3.49-3.77 0-.835-.297-1.517-.787-2.052.08-.192.341-.97-.075-2.022 0 0-.64-.206-2.1.783-.61-.17-1.364-.254-2.014-.257-.65.003-1.403.088-2.012.257-1.46-.989-2.103-.783-2.103-.783-.414 1.052-.153 1.83-.074 2.022a2.957 2.957 0 00-.787 2.051c0 2.928 1.784 3.584 3.482 3.777-.219.19-.317 1.58-.385 2.074-.436.195-1.543.533-2.224-.636 0 0-.404-.733-1.172-.787"/></g></svg></a>
									...
									<a href="https://www.instagram.com/_le_ali_/?hl=ru" target="_blank" rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21"><circle cx="10.5" cy="10.5" r="10" fill="none" stroke="#434A54" strokeLinecap="round" strokeMiterlimit="1" strokeLinejoin="round"/><path d="M14.01 16.5H6.99a2.49 2.49 0 01-2.49-2.49V6.99A2.49 2.49 0 016.99 4.5h7.02a2.49 2.49 0 012.49 2.49v7.02a2.49 2.49 0 01-2.49 2.49z" fill="none" stroke="#434A54" strokeLinecap="round" strokeMiterlimit="1" strokeLinejoin="round"/><circle cx="10.5" cy="10.5" r="2.96" fill="none" stroke="#434A54" strokeLinecap="round" strokeMiterlimit="1" strokeLinejoin="round"/><circle cx="13.98" cy="7.02" r=".94" fill="#434A54"/></svg></a>
									<a href="https://vk.com/alina8627" target="_blank" rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21"><g fill="none" stroke="#434A54" strokeLinecap="round" strokeMiterlimit="1" strokeLinejoin="round"><circle cx="10.5" cy="10.5" r="10"/><path d="M4.5 6.5c.2 2.08 2.76 8 6 8v-8M16.5 6.5c-.3 1.98-2.32 5-6 5M16.5 14.5c-.3-1.188-2.32-3-6-3"/></g></svg></a>
								</div>
							</div>	
						</div>
